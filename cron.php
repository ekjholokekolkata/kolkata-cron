<?php
// =========================================================================
// SECURITY GATE (ONLY ALLOW GITHUB CRON OR YOUR CALLS)
// =========================================================================
...
// =========================================================================
// DATABASE CONNECTION (INTERNAL ONLY - INFINITYFREE SAFE)
// =========================================================================
...
// =========================================================================
$q1 = $conn->query("SELECT id, title, watermark_text, image_url FROM kolkata_explore WHERE notification_sent = 0 LIMIT 5");
...
// =========================================================================
$q2 = $conn->query("SELECT id, user_name FROM story_reviews WHERE notification_sent = 0 LIMIT 5");
...
// MODULE 3: reviews
// =========================================================================
$q3 = $conn->query("SELECT id, name FROM reviews WHERE notification_sent = 0 LIMIT 5");
...
// =========================================================================
$q4 = $conn->query("SELECT id FROM instagram_links WHERE notification_sent = 0 LIMIT 5");
